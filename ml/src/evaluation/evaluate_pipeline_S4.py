...
def run_s4_pipeline():
    ...
    s_path = r"Synchronised V abd S datasets\Categorised IOVNB Dataset\S (Driver A)\S4\S-S4.csv"
    v_path = r"Synchronised V abd S datasets\Categorised IOVNB Dataset\S (Driver A)\S4\V-S4.csv"
    ...
    print("\n--- 3. Inference & Evaluation (on Full S4 dataset) ---")
    model.eval()
    with torch.no_grad():
    ...
    plot_path = os.path.join(os.path.dirname(__file__), "..", "..", "..", "docs", "ml", "trajectory_S4.png")
