...
def run_vfa02_pipeline():
    data_root = r"e:\idr-platform\ml\data"
    s_path = r"Synchronised V abd S datasets\Categorised IOVNB Dataset\Vf (Driver E)\V-Vfa02\S-Vfa02.csv"
    v_path = r"Synchronised V abd S datasets\Categorised IOVNB Dataset\Vf (Driver E)\V-Vfa02\V-Vfa02.csv"
    ...
    print("CURRENT DATASET: Vfa02 (Driver E)")
    ...
    print("\n--- 3. Inference & Evaluation (on Full Vfa02 dataset) ---")
    model.eval()
    with torch.no_grad():
    ...
    plot_path = os.path.join(os.path.dirname(__file__), "..", "..", "..", "docs", "ml", "trajectory_Vfa02.png")
