...
def run_vtb01_pipeline():
    data_root = r"e:\idr-platform\ml\data"
    s_path = r"Synchronised V abd S datasets\Categorised IOVNB Dataset\Vtb (Driver E)\Vtb01\S-Vtb1.csv"
    v_path = r"Synchronised V abd S datasets\Categorised IOVNB Dataset\Vtb (Driver E)\Vtb01\V-vtb1.csv"
    ...
    print("CURRENT DATASET: Vtb01 (Driver E)")
    ...
    print("\n--- 3. Inference & Evaluation (on Full Vtb01 dataset) ---")
    model.eval()
    with torch.no_grad():
    ...
    plot_path = os.path.join(os.path.dirname(__file__), "..", "..", "..", "docs", "ml", "trajectory_Vtb01.png")
