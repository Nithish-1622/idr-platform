...
def run_vfa01_pipeline():
    data_root = r"e:\idr-platform\ml\data"
    s_path = r"Synchronised V abd S datasets\Categorised IOVNB Dataset\Vf (Driver E)\V-Vfa01\S-Vfa01.csv"
    v_path = r"Synchronised V abd S datasets\Categorised IOVNB Dataset\Vf (Driver E)\V-Vfa01\V-Vfa01.csv"
    ...
    print("CURRENT DATASET: Vfa01 (Driver E)")
    ...
    print("\n--- 3. Inference & Evaluation (on Full Vfa01 dataset) ---")
    model.eval()
    with torch.no_grad():
    ...
    plot_path = os.path.join(os.path.dirname(__file__), "..", "..", "..", "docs", "ml", "trajectory_Vfa01.png")
