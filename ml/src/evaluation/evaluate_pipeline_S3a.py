...
def run_s3a_pipeline():
    ...
    print("\n--- 3. Inference & Evaluation (on Full S3a dataset) ---")
    model.eval()
    with torch.no_grad():
    ...
    plot_path = os.path.join(os.path.dirname(__file__), "..", "..", "..", "docs", "ml", "trajectory_S3a.png")
